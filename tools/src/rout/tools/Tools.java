...
public final class Tools{
    ...
    public static void main(String[] args){
        ...
        Reflect.<ObjectMap<Class<?>, ModMeta>>get(Mods.class, mods, "metas").put(Rout.class, meta);
    ...
    public static boolean load(Content content){
        synchronized(loaded){
            ...
            if(should){
                content.load();
                if (content instanceof MappableContent c) routContentRegionRegistry.load(c);
            }
